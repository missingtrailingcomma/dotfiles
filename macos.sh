...
# Increase sound qzuality for Bluetooth headphones/headsets
...
yes | cp -rf init/spectacle.json ~/Library/Application\ Support/Spectacle/Shortcuts.json 2> /dev/null
